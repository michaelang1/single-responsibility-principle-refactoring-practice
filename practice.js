...
function revenue(costOfPie, pieQuantity, profitMargin = 1.2) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
	...
	let costOfPie = costPerPie(recipe);
	// Calculate the total cost of all the pies
	revenue(costOfPie, pieQuantity, profitMargin);
}
